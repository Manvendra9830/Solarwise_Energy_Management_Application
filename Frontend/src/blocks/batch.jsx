...
const TreeSavingBadge10 = () => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Front Side */}
        <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-b from-green-500 via-green-400 to-green-600 shadow-xl rounded-full border-4 border-green-700 backface-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-gray-200 rounded-full transform rotate-y-180 backface-hidden">
          ...
          <h4 className="text-lg font-semibold mt-4">Tree Saver Novice</h4>
...
export default TreeSavingBadge10;
